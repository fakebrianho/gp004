...
export default function Particles(props) {
	...
	const camera0= useMemo(()=> new THREE.OrthographicCamera(-1, 1, 1, -1, -2, 2))
	...
	// const [renderTarget1, renderTarget2] = useMemo(() => [
	// 	new useFBO(SIZE, SIZE, { magFilter: THREE.NearestFilter, minFilter: THREE.NearestFilter, type: THREE.FloatType}),
	// 	new useFBO(SIZE, SIZE, { magFilter: THREE.NearestFilter, minFilter: THREE.NearestFilter, type: THREE.FloatType}),
	//   ], [size])
	...
	geometry.setAttribute(
		'pos',
		new THREE.InstancedBufferAttribute(particles, 3, false)
	)
