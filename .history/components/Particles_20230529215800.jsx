...
export default function Particles() {
	...
	let tempTexture
	Promise.all([getPixelDataFromImage('/logo.png', SIZE, NUMBER)]).then(
		(texture) => {
			tempTexture = texture[0]
		...
		<>
			{createPortal(
				<mesh>
					...
					<simulationMaterial
						ref={simMat}
						uPosition={tempTexture ? tempTexture : startingPosition}
						uOriginalPosition={
							tempTexture ? tempTexture : startingPosition
						}
					/>
				</mesh>,
				scene
