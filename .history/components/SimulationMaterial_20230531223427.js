...
const SimulationMaterial = shaderMaterial(
	...
	void main() {
        ...
        vec2 rotatedOriginal = rotationMatrix(uTime) * centeredFinalOriginal;
        vec2 rotatedFinalOriginal = rotatedCenteredFinalOriginal + vec2(0.5);
        ...
        // float dist = length( finalOriginal - position );
        float dist = length( rotatedFinalOriginal - position );
        if( dist > 0.01 ) {
