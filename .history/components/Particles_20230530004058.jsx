...
export default function Particles() {
	...
	useFrame(({ gl, mouse }) => {
		if (simMat.current) {
			...
			simMat.current.uniforms.uPosition.value = target1.texture
	...
	return (
		<>
				...
				<>
					{createPortal(
						<mesh>
							...
							<simulationMaterial
								ref={simMat}
								uCurrentPosition={startingPosition}
								uOriginalPosition={tempTexture}
								uOriginalPosition1={startingPosition}
								uOriginalPosition2={startingPosition}
							/>
						</mesh>,
						scene
					)}
			...
			<points>
				...
				<renderMaterial
					ref={renderMat}
					// uTex={new THREE.TextureLoader().load('/logo.png')}
					uTexture={startingPosition}
					transparent={true}
